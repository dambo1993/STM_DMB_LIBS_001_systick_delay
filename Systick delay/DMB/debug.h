...
#define DEBUG_BUTTON1_PULL_UP 	GPIO_MODER(DEBUG_BUTTON1_GPIO) |= ( 0x01 << ( 2 * DEBUG_BUTTON1_PIN));
#define DEBUG_BUTTON1_PULL_DOWN	GPIO_MODER(DEBUG_BUTTON1_GPIO) |= ( 0x02 << ( 2 * DEBUG_BUTTON1_PIN));
...
#define DEBUG_BUTTON2_PULL_UP 	GPIO_MODER(DEBUG_BUTTON2_GPIO) |= ( 0x01 << ( 2 * DEBUG_BUTTON2_PIN));
#define DEBUG_BUTTON2_PULL_DOWN	GPIO_MODER(DEBUG_BUTTON2_GPIO) |= ( 0x02 << ( 2 * DEBUG_BUTTON2_PIN));
...
#define DEBUG_BUTTON3_PULL_UP 	GPIO_MODER(DEBUG_BUTTON3_GPIO) |= ( 0x01 << ( 2 * DEBUG_BUTTON3_PIN));
#define DEBUG_BUTTON3_PULL_DOWN	GPIO_MODER(DEBUG_BUTTON3_GPIO) |= ( 0x02 << ( 2 * DEBUG_BUTTON3_PIN));
